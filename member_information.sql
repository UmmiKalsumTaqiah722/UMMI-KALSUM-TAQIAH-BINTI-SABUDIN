...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2023 at 03:51 PM
...
INSERT INTO `member_information` (`Name`, `ID_Number`, `Gender`, `Year_of_Born`, `Age`, `Discount`) VALUES
('Ummi Kalsum', 1, 'Female', 2004, 19, 50),
('Mail', 2, 'Male', 2013, 10, 45);
COMMIT;
